      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <Text style={styles.description}>
            Con el objetivo de brindarte una experiencia más personalizada, te invitamos a
            proporcionarnos tu ubicación. Esta información será utilizada de manera confidencial
            y exclusiva para recomendarte psicólogos y especialistas cercanos a tu zona, en caso
            de que lo solicites.
          </Text>
